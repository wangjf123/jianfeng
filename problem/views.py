...
def exercise_problem_page(request, problem_id):
    """
    前台题目详情页
    """
    try:
        ...
        return error_page(request, u"题目不存在")
    return render(request, "oj/problem/exercise_problem.html", {"problem": problem, "samples": json.loads(problem.samples)})
def exercise_knowledge_page(request, problem_id):
    """
    前台题目详情页
    """
    try:
        ...
        return error_page(request, u"题目不存在")
    return render(request, "oj/problem/exercise_knowledge.html", {"problem": problem, "samples": json.loads(problem.samples)})

def answerquestions_page(request, problem_id):
    """
    前台题目详情页
    """
    try:
        ...
        return error_page(request, u"题目不存在")
    return render(request, "oj/problem/exercise_answerquestions.html", {"problem": problem, "samples": json.loads(problem.samples)})
