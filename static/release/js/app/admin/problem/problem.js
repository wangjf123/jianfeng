...
}), require(["jquery", "avalon", "csrfToken", "bsAlert", "pager"], function(e, t, n, r) {
	t.ready(function() {
		function i(i) {
			var s = "/api/admin/problem/?paging=true&page=" + i + "&page_size=10";
			n.keyword != "" && (s += "&keyword=" + n.keyword), n.showVisibleOnly && (s += "&visible=true"), e.ajax({
				url: s,
				dataType: "json",
				method: "get",
				success: function(e) {
					e.code ? r(e.data) : (n.problemList = e.data.results, t.vmodels.problemPager.totalPage = e.data.total_page)
				}
			})
		}
		if (t.vmodels.problemList) n = t.vmodels.problemList;
		else {
			var n = t.define({
				$id: "problemList",
				problemList: [],
				...
				showEditProblemPage: function(e) {
					t.vmodels.admin.problemId = e, t.vmodels.admin.template_url = "template/problem/edit_problem.html"
				},
				showProblemSubmissionPage: function(e) {
					t.vmodels.admin.problemId = e, t.vmodels.admin.template_url = "template/problem/submission_list.html"
				},
				search: function() {
					i(1), t.vmodels.problemPager.currentPage = 1
				}
			});
...
}), define("problem_8_pack", function() {});