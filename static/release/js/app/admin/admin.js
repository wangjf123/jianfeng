...
define("csrfToken", [], function() {
	...
	return t
}), require(["jquery", "avalon", "csrfToken", "bsAlert", "bootstrap"], function(e, t, n, r) {
	t.ready(function() {
		function i(t) {
			e(t).attr("class", "list-group-item active")
		}

		function s(t) {
			e(".list-group-item").attr("class", "list-group-item")
		}

		function o(t) {
			e("#loading-gif").show(), l.template_url = t
		}
		...
		var a = [{
				...
				children: [{
					name: "公告管理",
					hash: "#announcement/announcement"
				}, {
					name: "用户管理",
					hash: "#user/user_list"
				}]
				...
				children: [{
					name: "题目列表",
					hash: "#problem/problem_list"
				}, {
					name: "创建题目",
					hash: "#problem/add_problem"
				}]
			}, {
				name: "比赛管理",
				children: [{
					name: "比赛列表",
					hash: "#contest/contest_list"
				}, {
					name: "创建比赛",
					hash: "#contest/add_contest"
				}]
			}, {
				name: "小组管理",
				children: [{
					...
					name: "加入小组请求",
					hash: "#group/join_group_request_list"
				}]
			}],
			f = [{
				name: "首页",
				...
				children: [{
					name: "作业列表",
					hash: "#contest/homework_list"
				}, {
					name: "布置作业",
					hash: "#contest/add_homework"
				}]
			}],
			l = t.define({
				$id: "admin",
				template_url: "template/" + u + ".html",
				username: "",
				adminType: 1,
				groupId: -1,
				problemId: -1,
		...
		e.ajax({
			...
			dataType: "json",
			success: function(e) {
				e.code || (l.username = e.data.username, l.adminType = e.data.admin_type, e.data.admin_type == 2 ? l.adminNavList = a : l.adminNavList = f)
			}
		}), t.scan(), window.onhashchange = function() {
			var e = window.location.hash.substring(1);
			e && (s(".list-group-item"), i("#li-" + e.replace("/", "-")), o("template/" + e + ".html"))
		}, setTimeout(function() {
			i("#li-" + u.replace("/", "-"))
		}, 500), e.ajaxSetup({
			beforeSend: n,
