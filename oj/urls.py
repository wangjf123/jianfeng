...
urlpatterns = [
    ...
    url(r'^contest/(?P<contest_id>\d+)/answerquestions/(?P<contest_problem_id>\d+)/$',
       "contest.views.answerquestions_page", name="answerquestions_page"),
    ...
    url(r'^exercise_problem/(?P<problem_id>\d+)/$', "problem.views.exercise_problem_page", name="problem_page"),
    url(r'^exercise_knowledge/(?P<problem_id>\d+)/$', "problem.views.exercise_knowledge_page", name="problem_page"),
    url(r'^exercise_answerquestions/(?P<problem_id>\d+)/$', "problem.views.answerquestions_page", name="answerquestions_page_page"),
